...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Lists.List(context.Background(), vibedropper.ListListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Lists.List(cancelCtx, vibedropper.ListListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Lists.List(deadlineCtx, vibedropper.ListListParams{})
		if err == nil {
